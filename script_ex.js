window.addEventListener('load', function() {
    ...
    .then(responce => {
        if (responce.status === 200) {
            ...
            throw new Error('Error promise1')
        }
    })
      .then(blob => {
    ...
    const promise2 = fetch('https://sites-cf.mhcache.com/t/738/202/1221738202/5002/500013_749062o406111cau6c32v0_A_1024x1536/filters:watermark(/watermarks/logo.png,-2p,-2p,0,0,5):watermark(/watermarks/palette.png,2p,-2p,5,0,5)/xuTjNZntCr2-JGE_6tio_ngljJ0=/.jpg')
    .then(responce => {
        if (responce.status === 200) {
            return responce.blob()
        } else {
            throw new Error('Error promise2')
        }
    })
      .then(blob => {
